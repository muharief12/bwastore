              ...
              <div class="col-lg-5">
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-3">
					...
					<div class="form-group">
						...
						/> --}}
						<input id="email" type="email" class="form-control w-75 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus aria-describedby="emailHelp">
						@error('email')
