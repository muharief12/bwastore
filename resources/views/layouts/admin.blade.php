...
<html lang="en">
  <head>
    ...
    @stack('prepend-style')
        ...
        <link href="https://cdn.datatables.net/v/bs4/dt-1.13.4/fc-4.2.2/fh-3.3.2/r-2.4.1/datatables.min.css" rel="stylesheet"/>
    @stack('addon-style')
  </head>
  ...
  <body>
    ...
    @stack('prepend-script')
        ...
        <script src="https://cdn.datatables.net/v/bs4/dt-1.13.4/fc-4.2.2/fh-3.3.2/r-2.4.1/datatables.min.js"></script>
